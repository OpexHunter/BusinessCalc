...
class Ui_BusinessCalc(object):
    def setupUi(self, BusinessCalc):
        if not BusinessCalc.objectName():
            BusinessCalc.setObjectName(u"BusinessCalc")
        BusinessCalc.resize(1042, 580)
        icon = QIcon()
        icon.addFile(u":/src_ico/online-shop-_1_.ico", QSize(), QIcon.Normal, QIcon.Off)
        BusinessCalc.setWindowIcon(icon)
        BusinessCalc.setStyleSheet(u"QMainWindow {\n"
"	background-color: rgba(255, 255, 255);\n"
"}")
        self.centralwidget = QWidget(BusinessCalc)
        self.centralwidget.setObjectName(u"centralwidget")
        self.TC = QFrame(self.centralwidget)
        self.TC.setObjectName(u"TC")
        self.TC.setGeometry(QRect(10, 10, 371, 561))
...
"}")
        ...
        self.rep_create.setStyleSheet(u"QPushButton {\n"
...
"}")
        ...
        self.rep_history.setStyleSheet(u"QPushButton {\n"
"    background-color: rgb(225,225,225);\n"
"    border: 1px solid rgba(0,0,0,0.2);\n"
"	border-radius: 5px;\n"
"}\n"
...
"}")
        ...
        BusinessCalc.setCentralWidget(self.centralwidget)

        self.retranslateUi(BusinessCalc)

        QMetaObject.connectSlotsByName(BusinessCalc)
    # setupUi

    def retranslateUi(self, BusinessCalc):
        BusinessCalc.setWindowTitle(QCoreApplication.translate("BusinessCalc", u"\u0411\u0438\u0437\u043d\u0435\u0441-\u043a\u0430\u043b\u044c\u043a\u0443\u043b\u044f\u0442\u043e\u0440 | \u041a\u0430\u043b\u044c\u043a\u0443\u043b\u044f\u0442\u043e\u0440 \u0440\u0435\u043d\u0442\u0430\u0431\u0435\u043b\u044c\u043d\u043e\u0441\u0442\u0438", None))
        self.label_54.setText(QCoreApplication.translate("BusinessCalc", u"\u0412\u0432\u043e\u0434 \u0438\u0437\u0434\u0435\u0440\u0436\u0435\u043a", None))
        self.label_48.setText(QCoreApplication.translate("BusinessCalc", u"\u0421\u0443\u0431\u0441\u0438\u0434\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 (\u0435\u0434\u0438\u043d\u043e\u0440\u0430\u0437\u043e\u0432\u043e\u0435)", None))
        self.i_TC5.setText("")
        self.i_TC5.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC5.setText("")
        self.label_45.setText(QCoreApplication.translate("BusinessCalc", u"\u041f\u043e\u043a\u0443\u043f\u043a\u0430 \u043e\u0431\u043e\u0440\u0443\u0434\u043e\u0432\u0430\u043d\u0438\u044f/\u043b\u0438\u0437\u0438\u043d\u0433", None))
        self.i_TC3.setText("")
        self.i_TC3.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC3.setText("")
        self.label_43.setText(QCoreApplication.translate("BusinessCalc", u"\u041f\u043e\u043a\u0443\u043f\u043a\u0430 \u043f\u043e\u043c\u0435\u0449\u0435\u043d\u0438\u044f (\u0415\u0441\u043b\u0438 \u043d\u0435 \u0430\u0440\u0435\u043d\u0434\u0443\u0435\u0442\u0441\u044f)", None))
        self.i_TC1.setText("")
        self.i_TC1.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC1.setText("")
        self.label_46.setText(QCoreApplication.translate("BusinessCalc", u"\u0420\u0435\u043a\u043b\u0430\u043c\u0430 \u0438 \u043c\u0430\u0440\u043a\u0435\u0442\u0438\u043d\u0433 (\u0421\u0442\u0430\u0440\u0442\u043e\u0432\u044b\u0435)", None))
        self.i_TC4.setText("")
        self.i_TC4.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC4.setText("")
        self.label_44.setText(QCoreApplication.translate("BusinessCalc", u"\u0420\u0435\u043c\u043e\u043d\u0442 \u043f\u043e\u0434 \u043f\u0440\u0435\u0434\u043f\u0440\u0438\u044f\u0442\u0438\u0435 (\u043f\u0435\u0440\u0435\u0441\u0442\u0440\u043e\u0439\u043a\u0430)", None))
        self.i_TC2.setText("")
        self.i_TC2.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC2.setText("")
        self.label_36.setText(QCoreApplication.translate("BusinessCalc", u"\u0424\u0438\u043a\u0441\u0438\u0440\u043e\u0432\u0430\u043d\u043d\u044b\u0435 \u0438\u0437\u0434\u0435\u0440\u0436\u043a\u0438", None))
        self.label_53.setText(QCoreApplication.translate("BusinessCalc", u"\u0423\u0431\u043e\u0440\u043a\u0430, \u0442\u0435\u0445. \u043e\u0431\u0441\u043b\u0443\u0436\u0438\u0432\u0430\u043d\u0438\u0435", None))
        self.i_TC10.setText("")
        self.i_TC10.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC10.setText("")
        self.label_122.setText(QCoreApplication.translate("BusinessCalc", u"\u0417\u041f, \u0437\u0430\u0442\u0440\u0430\u0442\u044b \u043d\u0430 \u043e\u0431\u0443\u0447\u0435\u043d\u0438\u0435 \u043f\u0435\u0440\u0441\u043e\u043d\u0430\u043b\u0430", None))
        self.i_TC8.setText("")
        self.i_TC8.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC8.setText("")
        self.label_149.setText(QCoreApplication.translate("BusinessCalc", u"\u0421\u0435\u0431\u0435\u0441\u0442\u043e\u0438\u043c\u043e\u0441\u0442\u044c \u0438\u043d\u0433\u0440\u0438\u0434\u0438\u0435\u043d\u0442\u043e\u0432 (\u0432 \u043c\u0435\u0441\u044f\u0446)", None))
        self.i_TC6.setText("")
        self.i_TC6.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC6.setText("")
        self.label_150.setText(QCoreApplication.translate("BusinessCalc", u"\u0421\u0442\u0440\u0430\u0445\u043e\u0432\u0430\u043d\u0438\u0435", None))
        self.i_TC9.setText("")
        self.i_TC9.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC9.setText("")
        self.label_151.setText(QCoreApplication.translate("BusinessCalc", u"\u041a\u0440\u0435\u0434\u0438\u0442 (%)", None))
        self.i_TC7.setText("")
        self.i_TC7.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC7.setText("")
        self.label_38.setText(QCoreApplication.translate("BusinessCalc", u"\u041f\u0435\u0440\u0435\u043c\u0435\u043d\u043d\u044b\u0435 \u0438\u0437\u0434\u0435\u0440\u0436\u043a\u0438", None))
        self.label_152.setText(QCoreApplication.translate("BusinessCalc", u"\u041a\u043e\u043c\u043c\u0443\u043d\u0430\u043b\u044c\u043d\u044b\u0435 \u0443\u0441\u043b\u0443\u0433\u0438", None))
        self.i_TC11.setText("")
        self.i_TC11.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC11.setText("")
        self.label_153.setText(QCoreApplication.translate("BusinessCalc", u"\u0417\u0430\u0442\u0440\u0430\u0442\u044b \u043d\u0430 \u043b\u043e\u0433\u0438\u0441\u0442\u0438\u043a\u0443", None))
        self.i_TC12.setText("")
        self.i_TC12.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC12.setText("")
        self.label_154.setText(QCoreApplication.translate("BusinessCalc", u"\u0420\u0435\u043a\u043b\u0430\u043c\u0430 \u0438 \u043c\u0430\u0440\u043a\u0435\u0442\u0438\u043d\u0433 (\u041f\u043e\u0441\u043b\u0435 \u0441\u0442\u0430\u0440\u0442\u0430)", None))
        self.i_TC13.setText("")
        self.i_TC13.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TC13.setText("")
        self.label_120.setText(QCoreApplication.translate("BusinessCalc", u"\u0412\u0432\u043e\u0434 \u0434\u0430\u043d\u043d\u044b\u0445 \u043f\u0440\u0435\u0434\u043f\u0440\u0438\u044f\u0442\u0438\u044f", None))
        self.label_119.setText(QCoreApplication.translate("BusinessCalc", u"\u0422\u0438\u043f \u0440\u0435\u0441\u0442\u043e\u0440\u0430\u043d\u0430", None))
        self.i_TR1_1.setItemText(0, QCoreApplication.translate("BusinessCalc", u"\u041e\u0431\u044b\u0447\u043d\u044b\u0439", None))
        self.i_TR1_1.setItemText(1, QCoreApplication.translate("BusinessCalc", u"\u0424\u0430\u0441\u0442 \u0444\u0443\u0434", None))

        self.label_39.setText(QCoreApplication.translate("BusinessCalc", u"\u0411\u0430\u0437\u043e\u0432\u044b\u0435 \u0434\u0430\u043d\u043d\u044b\u0435", None))
        self.label_118.setText(QCoreApplication.translate("BusinessCalc", u"\u041a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e \u043a\u043e\u043d\u043a\u0443\u0440\u0435\u043d\u0442\u043e\u0432", None))
        self.i_TR1_2.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"0", None))
        self.h_TR1_2.setText("")
        self.label_114.setText(QCoreApplication.translate("BusinessCalc", u"\u0410\u0434\u0440\u0435\u0441 ", None))
        self.i_TR4_1.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0433\u043e\u0440\u043e\u0434, \u0443\u043b\u0438\u0446\u0430, \u0434\u043e\u043c", None))
        self.label_40.setText(QCoreApplication.translate("BusinessCalc", u"\u0414\u043e\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0435 \u0434\u0430\u043d\u043d\u044b\u0435", None))
        self.label_121.setText(QCoreApplication.translate("BusinessCalc", u"\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435", None))
        self.i_TR4_2.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u043d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u0440\u0435\u0441\u0442\u043e\u0440\u0430\u043d\u0430", None))
        self.label_41.setText(QCoreApplication.translate("BusinessCalc", u"\u0421\u0440\u0435\u0434\u043d\u0438\u0439 \u0447\u0435\u043a (\u043d\u0430\u043f\u0440\u044f\u043c\u0443\u044e)", None))
        self.label_112.setText(QCoreApplication.translate("BusinessCalc", u"\u0421\u0440\u0435\u0434\u043d\u0438\u0439 \u0447\u0435\u043a", None))
        self.i_TR2_1.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TR2_1.setText("")
        self.label_42.setText(QCoreApplication.translate("BusinessCalc", u"\u0421\u0440\u0435\u0434\u043d\u0438\u0439 \u0447\u0435\u043a (\u041f\u043e \u0433\u043e\u0440\u043e\u0434\u0443)", None))
        self.label_156.setText(QCoreApplication.translate("BusinessCalc", u"\u0413\u043e\u0440\u043e\u0434", None))
        self.i_TR2_2.setItemText(0, QCoreApplication.translate("BusinessCalc", u"...", None))
        self.i_TR2_2.setItemText(1, QCoreApplication.translate("BusinessCalc", u"\u041c\u043e\u0441\u043a\u0432\u0430", None))
        self.i_TR2_2.setItemText(2, QCoreApplication.translate("BusinessCalc", u"\u0421\u0430\u043d\u043a\u0442-\u041f\u0438\u0442\u0435\u0440\u0431\u0443\u0440\u0433", None))

        self.h_TR2_2.setText("")
        self.label_113.setText(QCoreApplication.translate("BusinessCalc", u"\u041f\u043e \u0441\u0440\u0435\u0434\u043d\u0435\u0439 \u0417\u041f", None))
        self.label_157.setText(QCoreApplication.translate("BusinessCalc", u"\u0421\u0440\u0435\u0434\u043d\u044f\u044f \u0417\u041f", None))
        self.i_TR2_3.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"\u0440\u0443\u0431.", None))
        self.h_TR2_3.setText("")
        self.label_116.setText(QCoreApplication.translate("BusinessCalc", u"\u0422\u0440\u0430\u0444\u0438\u043a, \u043f\u043e\u0441\u0435\u0449\u0430\u0435\u043c\u043e\u0441\u0442\u044c Q", None))
        self.label_117.setText(QCoreApplication.translate("BusinessCalc", u"\u0422\u0440\u0430\u0444\u0438\u043a \u043f\u0440\u043e\u0436\u0438\u0432\u0430\u044e\u0449\u0438\u0445 (500\u043c)", None))
        self.i_TR3_1.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"0", None))
        self.h_TR3_1.setText("")
        self.label_115.setText(QCoreApplication.translate("BusinessCalc", u"\u0422\u0440\u0430\u0444\u0438\u043a \u043c\u0435\u0441\u0442 \u0441\u043a\u043e\u043f\u043b\u0435\u043d\u0438\u044f", None))
        self.i_TR3_3.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"0", None))
        self.h_TR3_3.setText("")
        self.label_158.setText(QCoreApplication.translate("BusinessCalc", u"\u0423\u0437\u043b\u043e\u0432\u043e\u0439 \u0442\u0440\u0430\u0444\u0438\u043a (\u041c\u0435\u0442\u0440\u043e, \u0442\u0440\u0430\u043d\u0441\u043f\u043e\u0440\u0442)", None))
        self.i_TR3_2.setPlaceholderText(QCoreApplication.translate("BusinessCalc", u"0", None))
        self.h_TR3_2.setText("")
        self.rep_create.setText(QCoreApplication.translate("BusinessCalc", u"\u0421\u043e\u0437\u0434\u0430\u0442\u044c \u043e\u0442\u0447\u0451\u0442", None))
        self.rep_history.setText(QCoreApplication.translate("BusinessCalc", u"\u0418\u0441\u0442\u043e\u0440\u0438\u044f \u043e\u0442\u0447\u0451\u0442\u043e\u0432", None))
        self.profile.setText(QCoreApplication.translate("BusinessCalc", u"\u041f\u0440\u043e\u0444\u0438\u043b\u044c", None))
        self.admin.setText(QCoreApplication.translate("BusinessCalc", u"\u0410\u0434\u043c\u0438\u043d\u0438\u0441\u0442\u0440\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435", None))
    # retranslateUi
